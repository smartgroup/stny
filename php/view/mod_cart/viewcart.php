...
<div class="cartlist">
	...
	<div class="cartlist_list">
		...
		<div class="cartlist_no"><?php _e('Quantity'); ?>：<?php echo Html::input('text', 'prod_num_'.$product->id, $_COOKIE['n_prd'.SessionHolder::get('user/id','0')][$product->id], 'size="4"'); ?><br /><a href="#" onclick="updateprodnum('<?php echo $product->id; ?>');">[<?php _e('Update quantity'); ?>]</a>&nbsp;&nbsp;<a href="#" onclick="removeprod('<?php echo $product->id; ?>');">[<?php _e('Remove'); ?>]</a></div>
