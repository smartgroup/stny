...
$curr_style['qq_show_type'] = $curr_style['qq_show_type']?$curr_style['qq_show_type']:'1';
/*
 * 浮动客服
 * for sitestarv1.3
 */
  ...
  <tr>
    <td class="zxkf_info" valign="top" align="center">
      <table class="zxkf_qqtable" border="0" cellspacing="0" cellpadding="0" width="135" align="center">
    	...
    	?>
    	<tr>
          <td height="30" align="center"><span><img src="http://wpa.qq.com/pa?p=4:<?php echo $online->account; ?>:4" align="absMiddle" alt="QQ" border="0" />&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq->account; ?>&site=qq&amp;Menu=yes" target=blank><?php echo $online->qqname; ?></a></span></td></tr>
    	<?php
    				break;
    			case '1': // MSN
        ?>
