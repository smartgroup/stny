...
if (!function_exists('showMenu')) {
    ...
    <?php
            if (sizeof($menu->slaves['MenuItem']) > 0) {
                $level++;
    ?>
    <span><a href="<?php if($menu->mi_category == 'outer_url'){ echo $menu->link; }else echo $menu->link; ?>">
    ...
    ?>
    <a href="<?php if($menu->mi_category == 'outer_url') echo $menu->link; else echo $menu->link; ?>" <?php if($menu->mi_category == 'outer_url'){echo "target='_blank'";}?>>
    <?php echo $menu->name; ?></a>
    <?php
            }
    ?>
