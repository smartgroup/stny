    ...
    <tbody>
       ...
       <!--
		...
		<tr>
        	...
        	<td colspan="3" class="entry">
            <input type="radio" name="mi[published]"  value="1" <?php if($curr_mi->published=='1'){echo 'checked';}?> />&nbsp;<?php _e('Yes'); ?>&nbsp;
            <input type="radio" name="mi[published]"  value="0" <?php if($curr_mi->published=='0'){echo 'checked';}?>/>&nbsp;<?php _e('No'); ?>&nbsp;
            </td>
        </tr>
        <tr>
            <td class="label"></td>
